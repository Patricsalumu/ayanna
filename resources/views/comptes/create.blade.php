    ...
    <div class="max-w-lg mx-auto mt-10 bg-white rounded-xl shadow-lg p-6">
        ...
        <form method="POST" action="{{ route('comptes.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="numero" class="w-full border rounded px-3 py-2" required value="{{ old('numero') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nom" class="w-full border rounded px-3 py-2" required value="{{ old('nom') }}">
