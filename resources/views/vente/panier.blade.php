                    ...
                    <table class="w-full text-base">
                        ...
                        <tbody>
                            @foreach($produitsPanier as $i => $item)
                                @if($i < $maxVisible)
                                    ...
                                    <tr class="border-b hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-2 py-3 text-right">{{ optional(auth()->user()?->entreprise)->formatAmount($item['prix'], true, 2) }}</td>
                                        <td class="px-4 py-3 text-right font-semibold">{{ optional(auth()->user()?->entreprise)->formatAmount($ligne, true, 2) }}</td>
                                    </tr>
                                @endif
                            @endforeach
                            ...
                            <tr class="bg-gray-100 font-bold">
                                ...
                                <td class="px-4 py-3 text-right">{{ optional(auth()->user()?->entreprise)->formatAmount($total, true, 2) }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
